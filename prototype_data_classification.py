# este script unificará los datos de las acciones de Apple y los puntajes de las noticias, en forma de clasificación
import pandas
...
for year in range(2010, 2016):
    ...
    for month in range(1, 13):
        ...
        if len(month_s) == 1:
            month_s = "0" + month_s
        # leemos el archivo
        f = open("D:\\Coding\\PyCharm Workspace\\ProyectoBigData\\datos\\class - year " + year_s + " month " + month_s + ".txt", "r")
        lines = f.readlines()
...
data.to_csv(r'D:\\Coding\\PyCharm Workspace\\ProyectoBigData\\datos\\prototype_data_class.csv')