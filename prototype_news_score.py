...
for year in range(2010, 2016):
    ...
    for month in range(1, 13):
        ...
        if path.exists("year " + year_s + " month " + month_s + ".txt"):
            continue
        print("    month " + month_s)
        ...
        while page <= page_max and status:
            ...
            if response.status_code == 200:
                ...
                for (date, link) in date_url:
                    ...
                    final_list.append((date, sia.polarity_scores(text=text)["compound"]))
        ...
        f = open("D:\\Coding\\PyCharm Workspace\\ProyectoBigData\\datos\\year " + year_s + " month " + month_s + ".txt", "w")
